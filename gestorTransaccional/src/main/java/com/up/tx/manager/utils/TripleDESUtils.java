...
public class TripleDESUtils {
	...
	private static final String DIGEST = "HG58YZ3CR9";
	private static final String PKCS5Padding = "DESede/CBC/PKCS5Padding";
...
//        final SecretKey key = new SecretKeySpec(keyBytes, "DESede");
//        final IvParameterSpec iv = new IvParameterSpec(new byte[8]);
//        final Cipher decipher = Cipher.getInstance(PKCS5Padding);
